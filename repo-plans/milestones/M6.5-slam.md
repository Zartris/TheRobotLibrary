...
Camera simulation infrastructure (2.5D Wolfenstein-style renderer, `common/camera.hpp` types, WebSocket streaming) is delivered in **M6 — Visual Perception Building Blocks**. M6.5 consumes these outputs directly.
